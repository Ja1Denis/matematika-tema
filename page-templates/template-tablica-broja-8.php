<?php
/**
 * Template Name: Tablica broja 8
 */

get_header();

// Link the CSS file
wp_enqueue_style('tablica-mnozenja-style', get_template_directory_uri() . '/assets/css/tablica-broja-8.css');

// Link the new JavaScript file
wp_enqueue_script('jquery');
wp_enqueue_script('tablica-mnozenja-script', get_template_directory_uri() . '/assets/js/tablica-broja-8.js', array('jquery'), '1.0', true);
?>

<div class="container tablica-broja-8">
    <header>
        <h1>Tablica množenja broja 8</h1>
        <div class="controls">
