<?php
/**
 * Template Name: Tablica broja 9
 */

get_header();

// Link the CSS file
wp_enqueue_style('tablica-mnozenja-style', get_template_directory_uri() . '/assets/css/tablica-broja-9.css');

// Link the new JavaScript file
wp_enqueue_script('jquery');
wp_enqueue_script('tablica-mnozenja-script', get_template_directory_uri() . '/assets/js/tablica-broja-9.js', array('jquery'), '1.0', true);
?>

<div class="container tablica-broja-9">
    <header>
        <h1>Tablica množenja broja 9</h1>
        <div class="controls">
